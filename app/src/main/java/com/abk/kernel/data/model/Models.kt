...
data class KernelBuildConfig(
    ...
    val koSourcePath: String = "modules/custom/abk_hello.c",
    val koModuleName: String = "abk_hello",
    val koBuildAllKnown: Boolean = false,
    val koIncludeLts: Boolean = false,
    val koKernelLocalversion: String = "",
    val koExtraCflags: String = "",
    val koBazelLto: String = "thin"
)
...
private fun String.hasKernelBuildSignal(): Boolean =
    "kernel" in this || "内核" in this ||
        "ko module" in this || "ko 模块" in this || "ko模块" in this ||
        ".ko" in this
